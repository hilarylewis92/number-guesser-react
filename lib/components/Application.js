...
export default class Application extends Component {
  ...
  submitBtn(){
    ...
    // debugger;
    this.messageHint(this.state.userGuess, this.state.randomNumberGenerated);
  }
      ...
      <section className = 'Application'>
        <span className = 'guessRange'>
          <GuessRange
            ...
            userMinimum = {this.state.userMinimum}
            userMaximum = {this.state.userMaximum}
          />
        </span>
        ...
        <span className = 'userGuess'>
          <UserGuess
            ...
            randomNumberGenerated = { this.state.messageHint }
          />
        </span>
